...
;;
;;this model has a slight repulsion from the wall and have a parallel swimming scheme. Wheh the agents hit a wall,
...
to forward-turtles-pingpong
  ask turtles [
    ...
    ifelse walls-infront = nobody [
      ...
      let rx (incident-x - 0.99 * scale * norm-x)
      let ry (incident-y - 0.99 * scale * norm-y)
