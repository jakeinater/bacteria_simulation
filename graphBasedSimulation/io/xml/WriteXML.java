...
public class WriteXML {
	...
	public static void write(Graph g, String filename, String path) {
		try {
			...
			Transformer transformer = transformerFactory.newTransformer();
			DOMSource source = new DOMSource(doc);
			StreamResult result = new StreamResult(new File(path + "/" + filename + ".graphml"));
			transformer.transform(source, result);
	...
	public static void writeUndir(Graph g, HashMap<String, Double> mapEdges, String filename, String path) {
		try {
